"""
Django settings for Browser_game project.
...
SECRET_KEY = 'django-insecure-st2!))djvn%#^!lwzdmn@_4l%36@&#)l5u5sa&^z95gw^u#n6s'
...
ROOT_URLCONF = 'Browser_game.urls'
...
WSGI_APPLICATION = 'Browser_game.wsgi.application'
...
LOGIN_REDIRECT_URL = 'create_character'
LOGOUT_REDIRECT_URL = '/'
